...
## Détails des Conflits et Résolutions
...
**Résolution** : Un échange collaboratif a eu lieu sur GitHub. Nour a corrigé son CSS selon les recommandations de la revue de code avant de procéder à l'intégration finale.